; Well, this one actually compiles to 518 bytes when DOS is targeted. If a
; bootloader was the target, then we could shave off a few opcodes (namely
; reseting the video mode to text mode on exit).
